...
export class DeckService {
    ...
    private static decks = [{edition: 'mobileapp', version: '1.1'}, {edition: 'webapp', version: '3.0'}];

    private static getVersion(edition: string): string
    {
        return DeckService.decks.find((deck: { edition: string; }) => deck.edition == edition)?.version || '3.0';
    }
