...
# OWASP Cornucopia is publishing it's darkest fears and secrets!
...
![Publish your threat model, at https://shostack.org/blog/publish-your-threat-model/](IMG_0156.webp)

So we went ahead and did just that. At cornucopia.owasp.org, you can now [find the threat model](https://cornucopia.owasp.org/copi#Our-Threat-Model) for the [OWASP Cornucopia Game Engine, Copi](https://copi.owasp.org/).
