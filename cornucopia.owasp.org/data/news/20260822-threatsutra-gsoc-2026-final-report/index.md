...
![GSoC logo](images/GSoC-logo-horizontal.svg)
...
![ThreatSutra architecture: adapters → orchestrator → AI → exporter](images/arc_overview.png)
...
![pytest-cov output showing 100% coverage across all modules](images/tests_coverage.png)
