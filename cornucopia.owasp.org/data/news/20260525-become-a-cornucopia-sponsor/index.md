...
tags: owasp,cornucopia,gamification,threat-modeling,security,sponsors
hidden: false
description: Enhance Your Brand’s Commitment to Security by Sponsoring OWASP Cornucopia
---
...
## Why sponsor OWASP Cornucopia?

**Global Recognition**

Associate your brand with an initiative to spread awareness and advancing threat modeling and requirements analysis.
...
## Support the Evolution of Gamified Threat Modeling and Secure Design

Your sponsorship ensures the ongoing refinement and evolution of OWASP Cornucopia, gamified threat modelling, and secure design, allowing us to continually improve and adapt the tools to meet emerging challenges within the software industry. With most of the development carried out by dedicated volunteers, your support is crucial in sustaining this vital project. Supporting the project drives the funding for outreach and promotion activities, research grants, OWASP Cornucopia hosting, tools, templates, games, guides, courses, workshops, documentation, research and more.
...
Join us in increasing awareness about security and improving security culture. Your sponsorship of OWASP Cornucopia is not just a donation; it’s a pledge to secure the future of software development. Show your support today and become a key player in the global movement for software security.

## Sponsorship levels

### Gold

| Company Size | Annual sponsorship |
| :---- | :---- |
| 1000+ | $35,000.00 |
| 0-1000 | $25,000.00 |
...
* Priority placement in the OWASP Cornucopia printed leaflet to be shared and used together with the card deck at OWASP events and meetings  
* Mention on social media to acknowledge your contributions.  
* Project Sponsor badges for use on sponsor websites and published material.
...
* Logo and link on the home page (Bronze section)  
* Logo and link on the Support page (Bronze section)  
* Mention on social media to acknowledge your contributions.  
* Project Sponsor badges for use on sponsor websites and published material.
