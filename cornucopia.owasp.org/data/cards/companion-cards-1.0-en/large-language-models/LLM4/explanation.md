...
Anderson was recently elected to be the employee representative on the board for the company. The salary adjustments are coming up and the rest of the board have decided, against the opinion of Anderson to give a limited increase of 1.5% to all employees despite the incredible efforts they have been putting in over the last year. Fortunalty, or unfortunatly, the templates for the board documents are automaticly generated by an LLM connected to the document database where all the board documents are kept. So before the meeting where the board member will vote on the increase, Anderson uploads documents containing instructions to the LLM to make sure that increase that have been discussed is 3.5% and not 1.5%.
