...
5. Verify that users are not able to define unauthorized virtual locations/addresses (e.g, database table names, file system paths, sms, email, domains, and URL paths).
