<div>
    ...
    <ul>
        <li>Legacy guides (DOCX):
            <ul>
                <li><a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_guide_bridge_en.docx">[EN]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_guide_bridge_es.docx">[ES]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_guide_bridge_fr.docx">[FR]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_guide_bridge_pt-br.docx">[PT-BR]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_guide_bridge_nl.docx">[NL]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_guide_bridge_no-nb.docx">[NO-NB]</a></li>
            </ul>
        </li>
        <li>Print-ready design files (IDML)
            <ul>
                <li>Website App Edition 2.0 card decks and leaflets: <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_en.zip">[EN]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_es.zip">[ES]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_fr.zip">[FR]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_pt-br.zip">[PT-BR]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_nl.zip">[NL]</a>, <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_webapp_2.00_no-nb.zip">[NO-NB]</a></li>
                <li>Mobile App Edition 1.0 card decks and leaflets: <a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_mobileapp_1.00_en.zip">[EN]</a></li>
            </ul>
        </li>
        <li>Print ready files printed in time for OWASP Global AppSec 2024 Lisbon (EN)
            <ul>
                <li><a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_global_appsec_lisbon_mobileapp_1.00_case_tarot_en.pdf">Mobile App Edition 1.0 tarot case</a></li>
                <li><a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_global_appsec_lisbon_mobileapp_1.00_leaflet_tarot_en.pdf">Mobile App Edition 1.0 tarot leaflet</a></li>
                <li><a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_global_appsec_lisbon_mobileapp_1.00_cards_tarot_en.pdf">Mobile App Edition 1.0 tarot card deck</a></li>
                <li><a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_global_appsec_lisbon_webapp_2.00_case_tarot_en.pdf">Website App Edition 2.0 tarot case</a></li>
                <li><a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_global_appsec_lisbon_webapp_2.00_leaflet_tarot_en.pdf">Website App Edition 2.0 tarot leaflet</a></li>
                <li><a href="https://github.com/OWASP/cornucopia/releases/download/v2.0.0/owasp_cornucopia_global_appsec_lisbon_webapp_2.00_cards_tarot_en.pdf">Website App Edition 2.0 tarot card deck</a></li>
            </ul>
        </li>
    </ul>
    ...
    <p>
        ...
        The fonts can also be downloaded from the web.<br/>
        Fivo Sans: <a href="https://www.fontsc.com/font/fivo-sans">https://www.fontsc.com/font/fivo-sans</a><br/>
        Atkinson Hyperlegible: <a href="https://brailleinstitute.org/freefont">https://brailleinstitute.org/freefont</a>
    </p>
    <p>
        The following fonts are used:
    </p>
    <ul>
        <li>Deck: Fivo Sans and Atkinson Hyperlegible</li>
        <li>Leaflet: Fivo Sans</li>
        <li>Cases:
            <ul>
                <li>Noto Sans Condensed Bold</li>
                <li>Noto Sans Condensed Extra Bold</li>
                <li>Noto Sans Condensed Medium</li>
                <li>Noto Sans ExtraCondensed Extra Bold</li>
                <li>Noto Sans ExtraCondensed Extra Medium</li>
            </ul>
        </li>
        <li>Logos:
            <ul>
                <li>- Noto Sans Condensed Bold</li>
                <li>- Noto Sans Condensed Extra Bold</li>
                <li>- Noto Sans Extra Condensed Extra Bold</li>
            </ul>
        </li>
    </ul>
    <h3 id="dimensions">Dimensions</h3>
    <h4 id="dimensions-decks">Card decks:</h4>
    <p>
    ...
    <h4 id="dimensions-cases">Cases:</h4>
    <p>
    ...
    <h4 id="dimensions-leaflets">Leaflets:</h4>
    <p>
    ...
    <p>
        Please be aware, that the table of content for the indesign leaflet has to be adjusted for all language versions before printing except for the english version!!<br/>
    ...
    <h4 id="dimensions-bleed">Blead:</h4>
    <p>
        A standard blead set to 3mm for all 4 sides. 
    </p>
    <h4 id="dimensions-bleed">Paper:</h4>
    <p>
