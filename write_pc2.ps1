...
Set-Content -Path "C:\Users\KIIT\cornucopia\cornucopia.owasp.org\data\cards\mobileapp-cards-1.1-en\platform-&-code\PC2\explanation.md" -Encoding UTF8 -Value $content
