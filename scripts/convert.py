...
class ConvertVars:
    ...
    VERSION_CHOICES: List[str] = ["all", "latest", "1.0", "1.1", "2.00", "2.1", "3.0", "5.0"]
    ...
    EDITION_VERSION_MAP: Dict[str, Dict[str, str]] = {
        "webapp": {"1.22": "1.22", "2.00": "2.00", "2.1": "2.1", "3.0": "3.0"},
        "against-security": {"1.00": "1.00"},
        "mobileapp": {"1.0": "1.0", "1.1": "1.1"},
        "all": {"1.22": "1.22", "2.00": "2.00", "2.1": "2.1", "1.0": "1.0", "1.1": "1.1", "3.0": "3.0", "5.0": "5.0"},
    }
...
def parse_arguments(input_args: List[str]) -> argparse.Namespace:
    ...
    description += "\nExample usage: $ scripts/convert.py --pdf -lt guide -l es -v 3.0"
    ...
    description += "\nExample usage: c:\\cornucopia\\scripts\\convert.py -t bridge -lt cards -l fr -v 3.0 -o"
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "\nVersion 3.0 will deliver cards mapped to ASVS 5.0 and the OWASP DevGuide"
