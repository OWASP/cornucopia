...
class TestParseDescription(unittest.TestCase):
    def test_parse_description_with_dict_and_text(self):
        ...
        description = {
            "Description": {
                "p": {
                    "__text": "This is a test description"
                }
            }
        }
                    ...
                    "Attack_Pattern": [
                        {
                            ...
                            "Description": {
                                "Description": {
                                    "p": {
                                        "__text": "Complex description text"
                                    }
                                }
                            }
                        }
