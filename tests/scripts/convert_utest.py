...
class TestGetMappingForEdition(unittest.TestCase):
    ...
    def test_get_mapping_dict_true(self) -> None:
        ...
        want_mapping_dict = {
            ...
            "${VE_VE2_owasp_dev_guide}": "SC1, SC2, SC3, SC4, SC8, SC9, SC10, SC11, SC12, SC13, FM1, FM2, FM5, EE6, EE7, EE8",
            "${VE_VE2_owasp_dev_guide_print}": "SC1-4, SC8-13, FM1-2, FM5, EE6-8",
            "${VE_VE2_owasp_asvs}": "2.4.1, 4.3.2, 13.2.2, 13.4.1, 13.4.2, 13.4.3, 13.4.4, 13.4.5, 13.4.6, 13.4.7, 15.2.3, 16.2.5, 16.3.4, 16.4.2, 16.5.1, 17.1.1",
            "${VE_VE2_owasp_asvs_print}": "2.4.1, 4.3.2, 13.2.2, 13.4.1-7, 15.2.3, 16.2.5, 16.3.4, 16.4.2, 16.5.1, 17.1.1",
            "${VE_VE2_capec}": "54, 113, 116, 143-144, 149-150, 155, 169, 215, 224, 497, 541, 546",
            "${VE_VE2_capec_map}": "{54: {'owasp_asvs': ['4.3.2', '13.2.2', '13.4.1', '13.4.2', '13.4.3', '13.4.4', '13.4.5', '13.4.6', '13.4.7', '15.2.3', '16.2.5', '16.4.2', '16.5.1', '17.1.1']}, 116: {'owasp_asvs': ['4.3.2', '13.2.2', '13.4.1', '13.4.2', '13.4.3', '13.4.4', '13.4.5', '13.4.6', '13.4.7', '15.2.3', '16.2.5', '16.4.2', '16.5.1', '17.1.1']}, 143: {'owasp_asvs': ['15.2.3']}, 144: {'owasp_asvs': ['15.2.3']}, 149: {'owasp_asvs': ['13.2.2', '13.4.1', '13.4.3', '13.4.7', '15.2.3']}, 150: {'owasp_asvs': ['13.2.2', '13.4.1', '13.4.2', '13.4.3', '13.4.4', '13.4.5', '13.4.6', '13.4.7', '15.2.3', '16.4.2']}, 155: {'owasp_asvs': ['13.2.2', '13.4.1', '13.4.3', '13.4.7', '15.2.3']}, 169: {'owasp_asvs': ['4.3.2', '13.2.2', '13.4.1', '13.4.2', '13.4.3', '13.4.4', '13.4.5', '13.4.6', '13.4.7', '15.2.3', '16.2.5', '16.3.4', '16.4.2', '16.5.1', '17.1.1']}, 215: {'owasp_asvs': ['2.4.1', '13.2.2', '13.4.2', '13.4.6', '16.2.5', '16.4.2', '16.5.1']}, 224: {'owasp_asvs': ['4.3.2', '13.2.2', '13.4.2', '13.4.4', '13.4.5', '13.4.6', '13.4.7', '15.2.3', '17.1.1']}, 497: {'owasp_asvs': ['13.2.2', '13.4.1', '13.4.3', '13.4.7', '15.2.3']}, 541: {'owasp_asvs': ['13.2.2', '13.4.2', '13.4.4', '13.4.5', '13.4.6', '13.4.7', '15.2.3']}, 546: {'owasp_asvs': ['15.2.3']}}",
            "${VE_VE2_safecode}": "4, 23",
            "${VE_VE2_owasp_cre}": "{'owasp_asvs': ['232-325', '774-888', '615-744', '067-050', '838-636', '253-452', '462-245', '743-110']}",
            "${VE_VE3_id}": "VE3",
            "${VE_VE3_value}": "3",
